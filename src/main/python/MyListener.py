...
class MyListener(compiladoresListener):
    def __init__(self, output_file):
        self.st = SymbolsTable.get_symbols_table()
        self.current_context = None
        self.output_file = output_file

    print("Hola estoy en MyListener!!!")

    #PRIMERO VAMOS A VER los bloques, luego las declaraciones y por ultimo las asignaciones.
